...
public class Attend {
	...
	private String Attend_StartTime ; // '입실시간',
	private String Attend_endTime; // '퇴실시간',
	...
	public String getAttend_StartTime() {
		return Attend_StartTime;
	}
	public void setAttend_StartTime(String attend_StartTime) {
		Attend_StartTime = attend_StartTime;
	}
	public String getAttend_endTime() {
		return Attend_endTime;
	}
	public void setAttend_endTime(String attend_endTime) {
